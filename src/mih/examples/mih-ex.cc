...
NS_LOG_COMPONENT_DEFINE ("WifiMihEx");
...
main (int argc, char *argv[])
{
  ...
  Ptr<mih::WifiMihLinkSap> mihLinkSap2 = wifiMifLinkSapHelper.Install (wifiApNode.Get (0));
  Ptr<mih::WifiMihLinkSap> mihLinkSap3 = wifiMifLinkSapHelper.Install (wifiApNode.Get (1));
  ...
  if (tracing == true)
    {
      phy.EnablePcap ("ex1", staDevices.Get (0));
